...
window.onload = function() {
    ...
    request2.onsuccess = function() {
        console.log('Manager data inputted');
        // Store the opened database object in the db variable. This is used a lot below
        db2 = request2.result;
    };
    ...
    function addData(e) {
        ...
        // update the display of data to show the newly added item, by running displayPlayers().
            displayPlayers();
        };
    ...
    function addData2(e) {
        ...
        managerInput.forEach((manager) => {

            let newItem = { managerValue: manager.value };
            ...
            // update the display of data to show the newly added item, by running displayManagers().
                displayManagers();
        };
    ...
    function displayManagers() {
        ...
        if(cursor) {
            ...
            managerData.textContent     = cursor.value.adp;
            nameData.textContent    = cursor.value.name;
            teamData.textContent    = cursor.value.team;
